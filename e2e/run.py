...
SCENARIOS = [
    ...
    ("widget-charts", "WidgetsTest#chartWidgets",
     "The 4×2 chart and the 4×4 on an empty launcher: both sparklines carry round weights and calendar dates."),
    ("chart-gestures", "ChartTest#rangesZoomAndPan",
     "The four ranges, a pinch that zooms about the fingers, a two-finger pan, and a scrub — each read back from the chart's own axis."),
